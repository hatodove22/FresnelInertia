...
observed failure. Preserve the shared synthesis pipeline, its parallel tilt
...
Update one owning document for each changed contract and 16 for current facts.
Do not append a running development diary to 16 or reprint completed features
in the plan. Keep priorities only in 08. Historical evidence belongs in docs/archive
