...
Current production status and remaining work are in
`23_ATOMS3_PRODUCTION_INTEGRATION.md` and `16_PROGRESS_STATUS.md`. The baseline
...
safe-stop, and compiles the servo backend out. Do not infer its full live-pipeline pass
