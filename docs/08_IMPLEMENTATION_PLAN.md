...
Updated: 2026-09-05, after the positive post-flash handling report;
preserve the tested experience and focus on fine exhibition tuning.
...
not a replacement JavaScript physics model. Both baseline firmware images were
installed and physical v4 pile/pressure transport was checked with outputs OFF.
...
- Carbonation uses shared sealed/burst/spent state: shaking builds charge,
  ...
  and mapping belong in [06](06_PARAMETER_MODEL.md). The AtomS3 update is flashed;
...
- Keep the object prominent. Mixtures can reuse the improved ingredients after
